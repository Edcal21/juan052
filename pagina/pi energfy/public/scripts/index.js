...
function epochToJsDate(epochTime){
  ...
  const loginElementBox = document.querySelector('#log-box');
  ...
  const setupUI = (user) => {
    if (user) {
      ...
      loginElementBox.style.display = 'none';
      contentElement.style.display = 'block';
      authBarElement.style.display ='block';
      userDetailsElement.style.display ='block';
      userDetailsElement.innerHTML = user.email;

      if (user.email == "espinoza.jfet73u@gmail.com"){
        userDetailsElement.innerHTML = 'Ing. Chavez';
      }
      if (user.email == "carlanuza0038@gmail.com"){
        userDetailsElement.innerHTML = 'Ing. Espinoza';
      }
